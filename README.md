...
[![npm downloads](https://img.shields.io/npm/dm/@exogroup/ngx-datatable.svg)](https://npmjs.org/@exogroup/ngx-datatable)
...
To use ngx-datatable in your project install it via [npm](https://www.npmjs.com/package/@exogroup/ngx-datatable):

```
npm i @exogroup/ngx-datatable --save
```
